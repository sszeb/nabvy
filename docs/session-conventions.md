...
- **Notes for the coordinator.** Send them to the coordinator session named at the top of `docs/handoff.md` (coordinator 6 is named at the top of `docs/handoff.md`; coordinator 5 was `session_01MarM2efLcMPfNeb48TbGoM`), never to a session that has handed off.
