...
| 0.8 | Config per module | in review: PR #26 open 14:43 (`session_01BRzRb2vTpUcTLr8gLRnXcz`, Sonnet) | 2026-09-24 | Raised by cost-meter (PR #16); see backlog. |
...
| 0.10 | Analytics and observability clients | in review: PR #28 open 14:56 (`session_016cJhsKgaKAhdbaffB5v8A5`, Sonnet) | 2026-09-24 | Plan in `docs/design/analytics-growth.md`; waits for nothing (keys optional). |
...
| 4.0b | Auth: audit admin actions | in review: PR #27 open 14:47 (`session_01QpzxV9s4Wihw96LgQmmoBf`, top); migration `better-auth/20260924143843_better_auth_audit_access.sql` to apply after merge | 2026-09-24 | Added after `audit-log`; see backlog. |
...
| incidents | 0 | PR #19 open; changes needed 14:46 (merge `main`); merged and lockfile fix pushed 14:57 (`fa7d90f`), CI pending; session at 456k tokens, hand-off due | `session_01WENzUdPXvaK5xkdy2unUvu` | Sonnet |
...
| switches | 1 | PR #23 open, approved 14:40; `main` merged after #24 landed (`c30e3af`), CI running | `session_01CtxXRGTqrS7tCXgFaNfw2J` | top |
