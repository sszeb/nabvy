...
| 0.10 | Analytics and observability clients | in review: PR #28 open 14:56, changes needed 15:15 (flag check needs the consent gate and local evaluation); `session_016cJhsKgaKAhdbaffB5v8A5`, Sonnet | 2026-09-24 | Plan in `docs/design/analytics-growth.md`; waits for nothing (keys optional). |
