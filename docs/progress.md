...
| 0.9d | Convention checks in CI | PR #61 open; "Changes needed" 21:54 (four rule bypasses; an undeclared migration `details-queue/20260924195052_details_queue_function_revoke.sql` to apply at merge); fresh fix session 21:58 (Sonnet), build session told to stand down | 2026-09-24 | `session_0191WVeLR7q6a2doJrmroAAU` (392k), Sonnet; fix `session_01RPpjJ7QGYT4JuDTeRxFzzb`, Sonnet |
| 0.17 | CI on the owner's self-hosted runner | done: PR #72 merged 23:31 (`9f7649e`), from reviewer 9 on the owner's instruction; runs queue until the runner is online (`docs/ops/self-hosted-runner.md`) | 2026-09-24 | `session_01HPaY77nosRBs1HAG3pMa2S`, top |
...
| 4.3af | Web: admin gate before any deploy | PR #67 open 22:23 (blocks 0.5a; from the #39 audit) | 2026-09-24 | `session_016GNggixVkbUZZ8T3qa1ent`, top |
...
| location | 6 | PR #69 open 22:24 [cp 8] | `session_0176Bmog6ujKPKrMXMcC3ztr` | Sonnet |
| details-selector | 6 | draft PR #68 22:20 [cp 4]; carries city-pages' rule-16 note | `session_01A62uwPYuT6wwgmQRZxgH2z` | Sonnet |
| copy-advert | 6 | PR #71 open 23:04 [cp 8] against main (#52 merged) | `session_01SjnaeR4J8QubvWLtjJu481` | Sonnet |
| price-drop-watch | 6 | draft PR #70 22:36 [cp 6], stacked on listing-lifecycle #57 (#52 merged) | `session_014TYnsXQS1LW8JUzAhBfJCA` | Sonnet |
| listing-card | 6 | started 21:55 [cp 5], stacked on listing-lifecycle #57 and listing-suppression #52 | `session_018iJZZkwTCHBK31jxgazFFs` | Sonnet |
