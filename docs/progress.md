...
| 0.8 | Config per module | in progress (`session_01BRzRb2vTpUcTLr8gLRnXcz`, Sonnet) | 2026-09-24 | Raised by cost-meter (PR #16); see backlog. |
...
| 0.9b | Test hook timeouts (PGlite) | in progress (`session_01NKCRQGK581AYjbjhh4hiEt`, Haiku trial) | 2026-09-24 | PR #24 open: raises vitest `hookTimeout` to 60 s for cost-meter, audit-log and auth; unblocks #23's CI. Judge Haiku on this review before using it more. |
| 0.10 | Analytics and observability clients | in progress (`session_016cJhsKgaKAhdbaffB5v8A5`, Sonnet) | 2026-09-24 | Plan in `docs/design/analytics-growth.md`; waits for nothing (keys optional). |
...
| 4.0b | Auth: audit admin actions | in progress (`session_01QpzxV9s4Wihw96LgQmmoBf`, top) | 2026-09-24 | Added after `audit-log`; see backlog. |
...
| incidents | 0 | PR #19 open; review fixes pushed 14:41, awaiting re-review | `session_01WENzUdPXvaK5xkdy2unUvu` | Sonnet |
...
| switches | 1 | PR #23 open, approved 14:40; CI red on a cost-meter PGlite timeout already on `main`, fixed by PR #24 (0.9b); merges `main` after that lands | `session_01CtxXRGTqrS7tCXgFaNfw2J` | top |
