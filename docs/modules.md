...
- **Tests:** entitlement matrix per plan and status; grant, expiry and bucket order; charge refused at zero and reversed on failure; checkout blocked without no-refunds consent; idempotent top-up webhook; boost expiry; referral credit applied once.
