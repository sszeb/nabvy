...
- Every account costs at most £2 a day by default, counting every paid action, checked in the gate (owner, 2026-09-24). Caps are policy rows edited in the admin panel.
