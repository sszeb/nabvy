...
| 4 | `run-coverage`, `details-queue`, `detail-evidence`, `seller-key`, `seller-reply-reports`, `ebay-adapter`, `ebay-sold`, `gumtree-adapter`, `subscriptions`, `boosts`, `lifecycle-messaging`, `trade-in-leads`, `fake-door` |
