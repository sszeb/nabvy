...
3. Subscribe to the open PRs: #28 (0.10 telemetry, changes needed: the PostHog flag check needs the consent gate and local evaluation), #30, and each PR the round-2 sessions open.
