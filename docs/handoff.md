...
1. `git fetch origin claude/coordinator-5` and base `claude/coordinator-6` on it (no PR is open from it; open one docs PR at your first batched push, then keep pushing to your branch).
