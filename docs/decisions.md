...
- **No map on or under a card.** The map is the Airbnb-style view already decided ("Search, map and pickup features", 2026-09-24; `search-map-routes.md` §3): the list on the left, approximate dots at town centroids on the right, clustered where dense.
