...
- 2026-09-25, demand-signals (w2): weekly counts of users' wants per search centre and catalogue family, derived from users' saved wants, kept internal; any later sharing of them.
...
- 2026-09-25, pickup-routes (4.1e): retention of user-entered pickup addresses, notes and points (30 days after the day, interim), and what the `.ics` download and navigation links share with third-party map apps at the user's tap.
