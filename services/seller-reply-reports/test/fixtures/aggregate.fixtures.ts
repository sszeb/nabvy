...
// Stage "aggregate": reports on one listing in, evidence rows out: weights, people, second answers
// and holds (design §3.1-3.3). Each case lists every evidence row written.
...
describe('aggregate', () => {
  for (const id of casesOf('aggregate')) {
    it(id, async () => {
