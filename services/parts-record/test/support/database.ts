...
// spend-governor, details-queue, quote-redaction, parts-ai and this module. Built like parts-ai's
// test support. Used as nabvy_pipeline, the role the module runs as. PGlite has no pg_net, PostGIS, pgvector or pg_trgm, so `create extension` lines are
