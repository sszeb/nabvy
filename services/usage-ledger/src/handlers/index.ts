// Event handlers. `account.deleted` → erase this module's rows for that user (rule 12). Idempotent:
// a redelivery finds nothing left to delete. Charges and grants are function calls, not events.
